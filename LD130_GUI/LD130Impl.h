...
typedef struct tag_BankHeadData {
    ...
    tag_BankHeadData()
    {
//	m_command			= 0;		// == TCommandList::ld130_BankData
	m_bankId			= 0;
...
//    unsigned short	m_command;		// == TCommandList::ld130_OutputData
    unsigned short	m_bankId;		// 0, 1, 2, 3, 4
...
typedef struct tag_HeadStatus {
    ...
    #endif
    unsigned short	m_command;			// == TCommandList::ld130_HeadStatus
...
public:
    ...
    int 	getActiveBank() const   { return m_activeBank; }
...
private:
    ...
    void getBankDataImpl(unsigned char aBankId);
